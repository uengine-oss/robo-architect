...
// Export document dialog ref
const exportDocDialogRef = ref(null)

function openExportDocument() {
  exportDocDialogRef.value?.show()
}
...
<template>
  <div class="right-panel-container">
    ...
    <div class="right-sidebar">
      ...
      <div class="right-sidebar__divider"></div>
      <button
        class="right-sidebar__icon"
        @click="openExportDocument"
    ...
    <!-- Export Document Dialog -->
    <ExportDocumentDialog ref="exportDocDialogRef" />
  </div>
