"""OpenAI Realtime API integration routes.

This capability issues ephemeral tokens for client-side WebRTC connections to OpenAI's Realtime API.
"""
    ...
    return [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "text": {"type": "string", "description": "스티커에 적힌 텍스트"},
                    "is_valid": {"type": "boolean", "description": "규칙에 맞는지 여부"},
                    "issue": {"type": "string", "description": "문제가 있다면 그 이유"},
        ...
        },
        {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "from_phase": {"type": "string", "description": "이전 단계"},
                    "to_phase": {
                        "type": "string",
                        "enum": [
                            "orientation",
                    ...
                    "announcement": {"type": "string", "description": "참가자에게 할 안내 메시지"},
                },
        ...
        },
        {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "topic": {"type": "string", "description": "팁 주제 (예: event, command, policy)"},
                    "tip": {"type": "string", "description": "팁 내용"},
                    "example": {"type": "string", "description": "예시"},
                },
                "required": ["topic", "tip"],
            },
        },
