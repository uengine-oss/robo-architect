...
- BL에 coupled_domain이 있으면 해당 BL은 다른 도메인의 로직이 포함된 것임
...
6. **다른 도메인 BL 처리**: coupled_domain이 있는 BL은 해당 도메인의 로직이 포함된 것입니다.
   같은 coupled_domain의 BL들은 해당 도메인의 US로 분리하거나, 맥락에 따라 함께 묶으세요.
"""
